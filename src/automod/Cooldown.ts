import { CommandInteraction, ContextMenuCommandInteraction, GuildMember, Message, User } from "discord.js";
...
export default class Cooldown {
    ...
    async start(msg: Message | CommandInteraction | ContextMenuCommandInteraction, options: CommandOptions | InteractionOptions): Promise <boolean> {
